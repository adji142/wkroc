...
function initMap() {
    ...
    var mapOptions = loadMapStyle('Assets/nodemaker/ajax/mapDay.json');
    map = new google.maps.Map(document.getElementById('map-canvas'),
            {
                // -7.5616659,110.6506352
                zoom: 12,
                center: {lat: -7.5616659, lng: 110.6506352},
    ...
    var locations = getVertexFromDatabase('<?php echo base_url() ?>ajax/vertex.php');
    ...
    for (i = 0; i < locations.length; i++) {
        var icon_marker;
        if (locations[i]["anggota"] === "C1") {
            icon_marker = 'Assets/nodemaker/assets/marker/asal.png';
        ...
        } else if (locations[i]["anggota"] === "C2") {
            icon_marker = 'Assets/nodemaker/assets/marker/tujuan.png';
            max_currentVertex = Number(locations[i][0]) + 1;
            marker = new google.maps.Marker({
                position: new google.maps.LatLng(locations[i]["lat"], locations[i]["lng"]),
                map: map,
        ...
        } else if (locations[i]["anggota"] === "C3"){
            icon_marker = 'Assets/nodemaker/assets/marker/node.png';
            max_currentVertex = Number(locations[i][0]) + 1;
            marker = new google.maps.Marker({
                position: new google.maps.LatLng(locations[i]["lat"], locations[i]["lng"]),
                map: map,
        ...
        console.log(locations[i]["anggota"] + " Koordinat : " + locations[i]["lat"]+","+locations[i]["lng"]);
        console.log(locations[i]);
        
        google.maps.event.addListener(marker, 'click', (function (marker, i) {
            return function () {
                var contents = "<b>Cluster Anggota: </b>" + locations[i]["anggota"] + "<br>" +
                        "<b>Nama UMKM: </b>" + locations[i]["NamaAnggota"] + "<br>" +
                        "<b>Nama Pemilik: </b>" + locations[i]["NamaPemilik"] + "<br>" +
                        "<b>Alamat: </b>" + locations[i]["Alamat"] + "<br>" +
                        "<b>Pemasaran: </b>" + locations[i]["Pemasaran"];
...
//start ambil graph dari database
    ...
    //             var icon_mrk;
    //             if (source == "TRUE") {
    //                 icon_mrk = 'Assets/nodemarker/assets/marker/asal.png';
    //             } else if (destination == "TRUE") {
    //                 icon_mrk = 'Assets/nodemarker/assets/marker/tujuan.png';
    //             } else {
    //                 icon_mrk = 'Assets/nodemarker/assets/marker/node.png';
    //             }
